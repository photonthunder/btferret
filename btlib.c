...
unsigned char lescanresponse[40] = { 36,0,0,0,0x01,0x09,0x20,0x20,0x0B,0x09,0x4D,0x79,0x20,
0x42,0x4C,0x45,0x20,0x44,0x65,0x76,0x12,0xFF,0xAA,0XBB,0xCC,0xDD,0xEE,0xFF,0x11,0x22,
0x33,0x44,0x55,0x66,0x77,0x88,0x99,0x00};

// unsigned char lescanresponse[40] = { 36,0,0,0,0x01,0x09,0x20,0x14,0x12,0xFF,
// 0xAA,0XBB,0xCC,0xDD,0xEE,0xFF,0x11,0x22,0x33,0x44,0x55,0x66,0x77,0x88,0x99,0x00};

// unsigned char lescanresponse[40] = { 36,0,0,0,0x01,0x09,0x20,0x08,0x06,0xFF,
...
int post_init_blue(void)
  ...
  if(gpar.lecap == 0)
    ...
    if(gpar.hidflag == 0)
      ...
      statusok(0,leadvert);
      VPRINT "Test Scan Response Data\n");
      sendhci(lescanresponse, 0);
      statusok(0, lescanresponse);
      }
    else
      {
      dev[0]->leaddtype = 1;
