...
def receive_hci_event(sock, timeout=5):
    """Function to receive and print HCI events with a timeout using select()"""
        ...
        if ready:
            try:
                ...
                if e.errno == 11:  # Resource temporarily unavailable
                    ...
                    return None
        time.sleep(0.1)
    print("Timeout: No HCI event received.")
    return None
...
def main():
    ...
    sock.setblocking(True)  # Use blocking mode
    ...
    try:
        ...
        # Continue with the other HCI commands...
